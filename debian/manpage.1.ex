.\"                                      Hey, EMACS: -*- nroff -*-
.\" (C) Copyright 2024 Vítězslav Dvořák <info@vitexsoftware.cz>,
.\"
...
.\"
.\" First parameter, SMS-INPUT, should be all caps
.\" Second parameter, SECTION, should be 1-8, maybe w/ subsection
.\" other parameters are allowed: see man(7), man(1)
.TH SMS-INPUT SECTION "13 Jan 2024"
...
.SH NAME
sms-input \- program to do something
.SH SYNOPSIS
.B sms-input
.RI [ options ] " files" ...
.br
...
.\" respectively.
\fBsms-input\fP is a program that...
.SH OPTIONS
